    ...
    if (document.getElementById('wysiwyg' + _eId) != null) {
        ...
        if (sel != null) {
            try {
                ...
                {
                    var caret = (ibody.lastChild.nodeType == 3) ? ibody.lastChild.nodeValue.length : (ibody.lastChild.tagName == "BR") ? 0 : 1;
                    try
                    {
                    ...
                    {
                        alert(caret + "/" + ibody.lastChild.tagName + "/" + ibody.lastChild.nodeType + "/" + ex);
                    }
                    sel.removeAllRanges();
                    sel.addRange(range);
                }
...
var iframe = '<table class="lzmWyzzEditor" id="wysiwyg' + n + 'table" cellpadding="0" cellspacing="0" border="0" style="width:' + wyzzW + m_SizeUnit+ '; height:' + wyzzH + m_SizeUnit+ ';border: 0px inset #dddddd;">' +
    '<tr><td valign="top" style="width:' + wyzzW + m_SizeUnit+ '; height:' + wyzzH + m_SizeUnit+ ';">\n'
  ...
  document.getElementById("wysiwyg" + n).style.height = wyzzH + m_SizeUnit;
  document.getElementById("wysiwyg" + n).style.width = wyzzW + m_SizeUnit;
  ...
  doc.open();
  doc.write('<html><head></head><link rel="stylesheet" type="text/css" href="js/wyzz/style.css"/><body>' + content + '</body></html>');
  doc.close();

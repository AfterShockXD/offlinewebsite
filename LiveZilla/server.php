...
if(isset($_POST["p_request"]) || isset($_GET[GET_SERVER_REQUEST_TYPE]))
{
    ...
    else if(isset($_GET[GET_SERVER_REQUEST_TYPE]) && $_GET[GET_SERVER_REQUEST_TYPE] == "cronjob")
    {
    ...
    if(DB_CONNECTION && !empty($CONFIG["gl_cjfs"]) && is("CALLER_TYPE") && !is("SERVERSETUP") && !is("LOGIN"))
    {
